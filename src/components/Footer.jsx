...
const Footer = () => {
  return (
    <div className="flex gap-5 w-full h-screen bg-zinc-900 p-15  font-['Grotesk']">
      <div className="w-1/2 h-full flex flex-col justify-between p-14">
        <div className="heading">
          <h1 className='text-[10vw] uppercase leading-none -mb-6'>Eye-</h1>
          <h1 className='text-[10vw] uppercase leading-none -mb-6'>Opening</h1>
        </div>
      ...
      <div className="w-1/2">
        <h1 className='text-[9vw] uppercase leading-none -mb-6'>
          PRESENTATIONS
        </h1>
        <div className="dets w-fit font-['Montreal'] mt-10">
        ...
        <div className="dets w-full font-['Montreal'] mt-10 flex justify-between">
            <div>
              <a className='block text-xl font-light mt-5 mb-5' href="#">L:</a>
              ...
              <a className='block text-xl font-light mt-8' href="#">30 Chukarina St</a>
              <a className='block text-xl font-light' href="#">Lviv, Ukraine</a>
            </div>
            <div className='mr-[5.5vw]'>
              <a className='block text-xl font-light mt-5 mb-5' href="#">M:</a>
        ...
        <div className="dets w-fit font-['Montreal'] mt-10">
            <a className='block text-xl font-light mt-5 mb-5' href="#">E:</a>
            <a className='block text-xl font-light' href="#">hello@ochi.design</a>
        </div>
        <div className="dets w-full font-['Montreal'] mt-10 flex justify-between">
            <a className='block text-xl font-light' href="#">© ochi design 2024. Legal Terms</a>
            <a className='block text-xl font-light mr-10' href="#">Website by Obys</a>
        </div>
      </div>
    </div>
  )
